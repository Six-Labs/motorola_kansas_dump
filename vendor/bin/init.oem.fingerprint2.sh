...
vendor_list=('focal' 'goodix')
kernel_so_list=("/vendor/lib/modules/$GKI_PATH/focal_fps_tee.ko" "/vendor/lib/modules/$GKI_PATH/goodix_fps_tee.ko")
kernel_so_name_list=("focal_fps_tee.ko" "goodix_fps_tee.ko")
hal_list=('focal_hal' 'goodix_hal')
